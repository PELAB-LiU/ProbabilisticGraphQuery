...
public interface StormSatelliteUtil {
  default Object runStorm(final SatelliteConfiguration cfg, final SatelliteModelWrapper instance, final CSVLog log) {
    Object _xblockexpression = null;
    {
      ...
      final Function1<Map.Entry<String, Double>, Pair<Integer, Double>> _function_1 = (Map.Entry<String, Double> entry) -> {
        Pair<Integer, Double> _xblockexpression_1 = null;
        {
          ...
          _xblockexpression_1 = Pair.<Integer, Double>of(Integer.valueOf(_parseInt), _value);
        }
