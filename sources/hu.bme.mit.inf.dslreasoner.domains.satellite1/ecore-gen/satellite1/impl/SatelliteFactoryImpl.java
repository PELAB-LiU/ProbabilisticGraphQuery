...
public class SatelliteFactoryImpl extends EFactoryImpl implements SatelliteFactory {
	...
	public EObject create(EClass eClass) {
		...
		case SatellitePackage.CONSTELLATION_MISSION:
			return createConstellationMission();
		case SatellitePackage.COMMUNICATING_ELEMENT:
			return createCommunicatingElement();
	 ...
	 */
	@Override
	public ConstellationMission createConstellationMission() {
		ConstellationMissionImpl constellationMission = new ConstellationMissionImpl();
		return constellationMission;
	}
	 ...
	 */
	@Override
	public CommunicatingElement createCommunicatingElement() {
		CommunicatingElementImpl communicatingElement = new CommunicatingElementImpl();
