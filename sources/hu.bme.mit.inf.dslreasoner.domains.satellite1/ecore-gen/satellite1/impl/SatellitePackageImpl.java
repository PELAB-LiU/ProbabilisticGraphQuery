...
import satellite1.InterferometryPayload;
...
public class SatellitePackageImpl extends EPackageImpl implements SatellitePackage {
	 ...
	 * @see satellite1.SatellitePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EReference getCommSubsystem_Fallback() {
	...
	public void createPackageContents() {
		...
		createEReference(commSubsystemEClass, COMM_SUBSYSTEM__FALLBACK);
	...
	public void initializePackageContents() {
		...
		initEReference(getCommSubsystem_Fallback(), this.getCommSubsystem(), null, "fallback", null, 0, 1,
				CommSubsystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
