...
public class Triple<T1 extends Object, T2 extends Object, T3 extends Object> {
  ...
  public Triple(final T1 fisrt, final T2 second, final T3 third) {
    super();
    this.fisrt = fisrt;
    this.second = second;
    this.third = third;
  ...
  public int hashCode() {
    ...
    return prime * result + ((this.third== null) ? 0 : this.third.hashCode());
  }
