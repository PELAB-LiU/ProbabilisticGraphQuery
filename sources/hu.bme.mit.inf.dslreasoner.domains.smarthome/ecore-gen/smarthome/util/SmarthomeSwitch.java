...
public class SmarthomeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SmarthomePackage.SMARTHOME: {
			...
			case SmarthomePackage.MEASUREMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Smarthome</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Smarthome</em>'.
