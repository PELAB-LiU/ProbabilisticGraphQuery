 ...
 * </p>
 * <ul>
 *   <li>{@link smarthome.impl.PersonImpl#getConfidence <em>Confidence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonImpl extends MinimalEObjectImpl.Container implements Person {
	...
	public void setConfidence(double newConfidence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmarthomePackage.PERSON__CONFIDENCE, oldConfidence, confidence));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SmarthomePackage.PERSON__CONFIDENCE:
