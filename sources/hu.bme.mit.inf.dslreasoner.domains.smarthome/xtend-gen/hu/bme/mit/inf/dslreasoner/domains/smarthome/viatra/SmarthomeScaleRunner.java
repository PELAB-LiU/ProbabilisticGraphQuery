...
public class SmarthomeScaleRunner extends ViatraScaleRunner<SmarthomeConfiguration> {
  ...
  public void runIncremental(final CSVLog log) {
    ...
    try {
      ...
      final String coverage = this.getMatchesJSON(this.parsed, this.engine, this.instance.idmap);
