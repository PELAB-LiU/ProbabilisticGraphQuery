...
public interface ProblogSmarthomeUtil {
  default boolean runProblog(final SmarthomeConfiguration cfg, final SmarthomeModel instance, final CSVLog log) {
    try {
      ...
      final String plmodel = new SmarthomeProblogGenerator().generateFrom(instance.model).toString();
  ...
  default String problogToJSON(final SmarthomeModel instance, final Map<String, Object> data, final boolean timeout) {
    ...
    _builder.newLine();
    {
      ...
      for(final Map.Entry<String, Object> entry : _entrySet) {
        ...
        String _get = instance.idmap.get(instance.ofHashCode(Integer.parseInt(entry.getKey())));
